 ...
 * new editable field is one schema edit (architecture ticket 07). The editable fields are the two
 * free-text panels and the salary expectation; anything else on a Job changes only through a
 * dedicated action (stage) or not at all (ticket 11).
 */
