...
1. Why this role. Name the role and the company, then the overlap: the requirements the posting leads with, and where the resume shows the applicant doing that work — the languages, frameworks, tools, and kind of product the posting names, in the posting's own terms. Say plainly why they are applying, without a stock opener. Three sentences at most.
