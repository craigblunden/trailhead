...
| **DET-9**: "The cover-letter action is present but disabled and labelled 'coming soon'." Out of scope: "cover-letter generation" | **Real** | Cover letters written by `claude-opus-5` from the job description and the attached resume, through a Route Handler, under a quota of five a week, with every failure explained (18, 19) |
